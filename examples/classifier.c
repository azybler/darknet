...
void predict_classifier(char *datacfg, char *cfgfile, char *weightfile, char *filename, int top)
{
    ...
    while(1){
        ...
        show_image(im, "predict_classifier_im", 0);

        printf("[predict_classifier] im.w = %d\n", im.w);
        printf("[predict_classifier] im.h = %d\n", im.h);

        image r = letterbox_image(im, net->w, net->h);
        show_image(r, "predict_classifier_r", 0);

        printf("[predict_classifier] r.w = %d\n", r.w);
        printf("[predict_classifier] r.h = %d\n", r.h);

        printf("[predict_classifier] net->w = %d\n", net->w);
        printf("[predict_classifier] net->h = %d\n", net->h);
